...
class DatabaseCollectionCreator {
  ...
  static async validateCollections() {
    ...
    const readyCount = validationResults.filter(function(r) { return r.status === 'ready'; }).length;
...
if (typeof global !== 'undefined') {
  global.DatabaseCollectionCreator = DatabaseCollectionCreator;
}

// 输出提示信息
console.log('💡 数据库集合创建工具已加载');
console.log('🚀 请执行: DatabaseCollectionCreator.execute()');
console.log('='.repeat(50));